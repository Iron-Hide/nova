...
* [beta - v2.2](https://github.com/anza-xyz/nova/blob/v2.2/CHANGELOG.md)
* [stable - v2.1](https://github.com/anza-xyz/nova/blob/v2.1/CHANGELOG.md)
...
* Changes
  ...
  * Unhide `--accounts-db-access-storages-method` for nova-validator and nova-ledger-tool and change default to `file`
...
```
  * `nova-validator`: Update PoH speed check to compare against current hash rate from a Bank (#2447)
...
* Breaking
  ...
  * Deprecated arguments removed from `nova-validator`:
