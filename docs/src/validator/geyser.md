...
- [`nova-geyser-plugin-interface`] &mdash; This crate defines the plugin
interfaces.

- [`solana-accountsdb-plugin-postgres`] &mdash; The crate for the referential
plugin implementation for the PostgreSQL database.

[`nova-geyser-plugin-interface`]: https://docs.rs/nova-geyser-plugin-interface
...
The Plugin interface is declared in [`nova-geyser-plugin-interface`]. It
