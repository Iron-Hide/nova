...
title: Home
sidebar_label: Home
pagination_label: Nova Validator Documentation Home
description: "Nova is a validator for the Solana blockchain maintained by the Anza core engineering team \
  it is a fork of the original Solana validator software."
---

# Nova Validator Documentation
...
interoperable and decentralized. Nova is a fork of the original Solana validator
previously maintained by the Solana Labs team. Nova is now under active development by the
...
Explore what it takes to operate an Nova validator and help secure the network.
