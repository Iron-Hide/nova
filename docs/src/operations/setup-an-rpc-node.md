---
title: Setup an Nova RPC Node
sidebar_label: Setup an Nova RPC Node
sidebar_position: 6
---
...
> For more explanation on the flags used in the command, refer to the `nova-validator --help` command
